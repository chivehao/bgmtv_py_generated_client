...
class Index(BaseModel):
    ...
    title: StrictStr
    desc: StrictStr
    total: Optional[StrictInt] = Field(default=0, description="收录条目总数")
    stat: Stat = Field(description="目录评论及收藏数")
    created_at: datetime
    updated_at: datetime
    creator: Creator
    ban: StrictBool = Field(description="deprecated, always false.")
    nsfw: StrictBool
    __properties: ClassVar[List[str]] = ["id", "title", "desc", "total", "stat", "created_at", "updated_at", "creator", "ban", "nsfw"]
