...
class SearchPersonsRequestFilter(BaseModel):
    """
    不同条件之间是 `且` 的关系
    """ # noqa: E501
    career: Optional[List[StrictStr]] = Field(default=None, description="职业，可以多次出现。多值之间为 `且` 关系。")
    __properties: ClassVar[List[str]] = ["career"]
