...
class PersonRevisionProfession(BaseModel):
    ...
    mangaka: Optional[StrictStr] = None
    artist: Optional[StrictStr] = None
    seiyu: Optional[StrictStr] = None
    writer: Optional[StrictStr] = None
    illustrator: Optional[StrictStr] = None
    actor: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["producer", "mangaka", "artist", "seiyu", "writer", "illustrator", "actor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mangaka": obj.get("mangaka"),
            "artist": obj.get("artist"),
            "seiyu": obj.get("seiyu"),
            "writer": obj.get("writer"),
            "illustrator": obj.get("illustrator"),
            "actor": obj.get("actor")
        })
        return _obj
