...
class LegacyMonoBaseImages(BaseModel):
    """
    肖像
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["large", "medium", "small", "grid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LegacyMonoBaseImages from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LegacyMonoBaseImages from a dict"""
        if obj is None:
            return None
