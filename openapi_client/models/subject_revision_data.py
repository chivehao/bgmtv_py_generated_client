...
class SubjectRevisionData(BaseModel):
    ...
    """ # noqa: E501
    field_eps: StrictInt
    field_infobox: StrictStr
    field_summary: StrictStr
    name: StrictStr
    name_cn: StrictStr
    platform: StrictInt
    ...
    type: StrictInt
    type_id: StrictInt
    vote_field: StrictStr
    __properties: ClassVar[List[str]] = ["field_eps", "field_infobox", "field_summary", "name", "name_cn", "platform", "subject_id", "type", "type_id", "vote_field"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "field_eps": obj.get("field_eps"),
            "field_infobox": obj.get("field_infobox"),
            "field_summary": obj.get("field_summary"),
            "name": obj.get("name"),
