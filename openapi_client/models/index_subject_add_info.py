...
class IndexSubjectAddInfo(BaseModel):
    """
    新增某条目到目录的请求信息
    """ # noqa: E501
    subject_id: Optional[StrictInt] = None
    sort: Optional[StrictInt] = Field(default=None, description="排序条件，越小越靠前")
    comment: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["subject_id", "sort", "comment"]
