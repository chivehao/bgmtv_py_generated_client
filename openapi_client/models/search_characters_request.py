...
class SearchCharactersRequest(BaseModel):
    ...
    """ # noqa: E501
    keyword: StrictStr
    filter: Optional[SearchCharactersRequestFilter] = None
    __properties: ClassVar[List[str]] = ["keyword", "filter"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "filter": SearchCharactersRequestFilter.from_dict(obj["filter"]) if obj.get("filter") is not None else None
        })
        return _obj
