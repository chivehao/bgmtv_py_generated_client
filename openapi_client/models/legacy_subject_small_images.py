...
class LegacySubjectSmallImages(BaseModel):
    """
    封面
    """ # noqa: E501
    large: Optional[StrictStr] = None
    common: Optional[StrictStr] = None
    medium: Optional[StrictStr] = None
    small: Optional[StrictStr] = None
    grid: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["large", "common", "medium", "small", "grid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LegacySubjectSmallImages from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LegacySubjectSmallImages from a dict"""
        if obj is None:
            return None
