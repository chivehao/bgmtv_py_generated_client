...
class ErrorDetail(BaseModel):
    ...
    details: Optional[Detail] = None
    __properties: ClassVar[List[str]] = ["title", "description", "details"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "details": Detail.from_dict(obj["details"]) if obj.get("details") is not None else None
        })
        return _obj
