...
class SlimSubject(BaseModel):
    ...
    name: StrictStr
    name_cn: StrictStr
    short_summary: StrictStr = Field(description="截短后的条目描述。")
    ...
    collection_total: StrictInt = Field(description="收藏人数")
    score: Union[StrictFloat, StrictInt] = Field(description="分数")
    rank: StrictInt = Field(description="排名")
    tags: List[Tag] = Field(description="前 10 个 tag")
    __properties: ClassVar[List[str]] = ["id", "type", "name", "name_cn", "short_summary", "date", "images", "volumes", "eps", "collection_total", "score", "rank", "tags"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "eps": obj.get("eps"),
            "collection_total": obj.get("collection_total"),
            "score": obj.get("score"),
            "rank": obj.get("rank"),
