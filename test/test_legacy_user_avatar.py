...
class TestLegacyUserAvatar(unittest.TestCase):
    """LegacyUserAvatar unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LegacyUserAvatar:
        """Test LegacyUserAvatar
