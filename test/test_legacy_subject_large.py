...
class TestLegacySubjectLarge(unittest.TestCase):
    """LegacySubjectLarge unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LegacySubjectLarge:
        """Test LegacySubjectLarge
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LegacySubjectLarge`
        """
        model = LegacySubjectLarge()
        if include_optional:
            return LegacySubjectLarge(
                id = 12,
                ...
                eps = [
                    openapi_client.models.legacy_episode.Legacy_Episode(
                        id = 1027, 
                        url = 'https://bgm.tv/ep/1027', 
                        type = 0, 
                        sort = 1, 
                        name = 'ちぃ 目覚める', 
                        name_cn = '叽，觉醒了', 
                ...
                topic = [
                    openapi_client.models.legacy_topic.Legacy_Topic(
                        id = 56, 
                        url = '', 
                        title = '', 
                        main_id = 56, 
                ...
                blog = [
                    openapi_client.models.legacy_blog.Legacy_Blog(
                        id = 56, 
                        url = '', 
                        title = '', 
                        summary = '', 
    ...
    def testLegacySubjectLarge(self):
        """Test LegacySubjectLarge"""
