...
class TestIndexBasicInfo(unittest.TestCase):
    """IndexBasicInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IndexBasicInfo:
        """Test IndexBasicInfo
