...
class TestLegacySubjectMedium(unittest.TestCase):
    """LegacySubjectMedium unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LegacySubjectMedium:
        """Test LegacySubjectMedium
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LegacySubjectMedium`
        """
        model = LegacySubjectMedium()
        if include_optional:
            return LegacySubjectMedium(
                id = 12,
    ...
    def testLegacySubjectMedium(self):
        """Test LegacySubjectMedium"""
