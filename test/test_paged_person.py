...
class TestPagedPerson(unittest.TestCase):
    """PagedPerson unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PagedPerson:
        """Test PagedPerson
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PagedPerson`
        """
        model = PagedPerson()
        if include_optional:
            return PagedPerson(
